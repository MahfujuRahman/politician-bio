        ...
        <div class="card" id="home_page_headings">
          <div class="card-body">
            <div class="d-flex">
              ...
              >
               <li class="nav-item" @click="tab = 'volunteer_banner'">
                  <a
                    :class="tab == 'volunteer_banner' ? ' active' : ''"
                    href="javascript:void();"
                    data-target="#volunteer_banner"
                    data-toggle="pill"
                    class="nav-link"
                    ><i class="icon-note"></i>
